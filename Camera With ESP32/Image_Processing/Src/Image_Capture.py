...
MQTT_TOPIC = "mosyrf/camera" # --- Ini adalah topik yang benar (sesuai ESP32)
...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        if image is not None:
            ...
            # --- MODIFIKASI: Blok untuk menyimpan gambar ---
            try:
                # 2. Buat nama file unik berdasarkan timestamp (milidetik)
                ...
                print(f"Gambar disimpan: {save_path}") # Uncomment jika ingin notifikasi
            except Exception as e:
                print(f"Gagal menyimpan gambar {save_path}: {e}")
            # --- AKHIR MODIFIKASI ---
...
if __name__ == "__main__":
    ...
    # --- MODIFIKASI: Buat direktori penyimpanan jika belum ada ---
    if not os.path.exists(SAVE_DIR):
        os.makedirs(SAVE_DIR)
        print(f"Direktori '{SAVE_DIR}' telah dibuat.")
    # --- AKHIR MODIFIKASI ---
